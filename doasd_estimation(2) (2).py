# -*- coding: utf-8 -*-
"""DOASD_Estimation(2).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/github/quaziemma/DUAL_SHRINKAGE_ESTIMATOR/blob/main/DOASD_Estimation(2).ipynb
"""
...
for n_samples in sample_sizes:
    ...
    for estimator_name, estimator in [('Ledoit-Wolf', LedoitWolf()),
                                      ('OAS', OAS()),
                                      ('OASD', ShrunkCovariance(shrinkage=0.6)),
                                      ('DOASD', DOASD(diagonal_shrinkage=0.4, off_diagonal_shrinkage=0.2)),  # Set off_diagonal_shrinkage = 0.5
                                      ('DualShrinkage', DualShrinkageEstimator(delta_diag=0.4, delta_off_diag=0.2))]:
        rmse = compute_rmse(estimator, X_train)
        rmse_results[estimator_name].append(rmse)
...
plt.vlines(0.6, ymin, ymax, color='blue', linestyle='--', linewidth=3, label='Dual Shrinkage Diagonal Shrinkage')
plt.vlines(0.4, ymin, ymax, color='orange', linestyle='--', linewidth=3, label='Dual Shrinkage Off-diagonal Shrinkage')
